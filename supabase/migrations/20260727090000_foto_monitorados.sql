-- listar_monitorados nunca devolvia picture -- o front lia
-- m.snapshot.imagem (foto do dia do PEDIDO, so existe se veio da fila
-- da extensao) em vez da foto real do catalogo, que ja existe pra
-- quase todo produto desde o sincronizarProdutos em escala.
-- returns table muda de forma -> precisa dropar antes.
