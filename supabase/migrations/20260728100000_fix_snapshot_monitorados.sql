-- Regressao: 20260727090000_foto_monitorados.sql dropou+recriou
-- listar_monitorados pra somar p.picture e esqueceu de trazer t.snapshot
-- de volta (existia desde 20260725060000_monitorados_snapshot.sql).
-- Resultado: Receita acumulada/Vendas por mes/Total vendas ficavam
-- sempre "-" pra todo mundo, nao so pra quem nunca teve snapshot.
